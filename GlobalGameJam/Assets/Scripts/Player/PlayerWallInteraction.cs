...
public class PlayerWallInteraction : MonoBehaviour
{
    ...
    {
        RaycastHit2D leftHitUp = (Physics2D.Raycast(transform.position + _raycastOffsetLeftUp, transform.TransformDirection(Vector3.right), _extraRaycastSize, _layerMask));
        RaycastHit2D leftHitDown = (Physics2D.Raycast(transform.position + _raycastOffsetLeftDown, transform.TransformDirection(Vector3.right), _extraRaycastSize,_layerMask));
        RaycastHit2D rightHitUp = (Physics2D.Raycast(transform.position + _raycastOffsetRightUp, transform.TransformDirection(Vector3.left), _extraRaycastSize,_layerMask));
        RaycastHit2D rightHitDown = (Physics2D.Raycast(transform.position + _raycastOffsetRightDown, transform.TransformDirection(Vector3.left), _extraRaycastSize,_layerMask));
